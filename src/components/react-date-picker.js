...
(function (global, factory) {
	...
	var ReactDOM = typeof require === "function" ? require("react-dom") : window.React;
var createReactClass = require('create-react-class');
    ...
    var DatePicker = createReactClass({displayName: "exports",
    ...
    var Calendar = createReactClass({displayName: "Calendar",
        getInitialState: function() {
            return {
                visible: false
            };
    ...
    var MonthHeader = createReactClass({displayName: "MonthHeader",
    	getInitialState: function() {
    		return {
    ...
    var WeekHeader = createReactClass({displayName: "WeekHeader",
    	render: function() {
    ...
    var Weeks = createReactClass({displayName: "Weeks",
    	getInitialState: function() {
    		return {
    			view: DateUtilities.clone(this.props.view),
    ...
    var Week = createReactClass({displayName: "Week",
